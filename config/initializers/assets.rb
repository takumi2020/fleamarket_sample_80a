...
Rails.application.config.assets.precompile += %w( itemindex.css )
Rails.application.config.assets.precompile += %w( itemnew.css )
Rails.application.config.assets.precompile += %w( usernew/new_credit.css )
Rails.application.config.assets.precompile += %w( itemdone.css )
